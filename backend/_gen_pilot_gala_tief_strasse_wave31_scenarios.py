"""Generator Pilot-Welle 31 — PANZEK-Tagesstunden-Sphäre (300 gesamt).
...
OUT = Path(__file__).parent / "pilot_gala_tief_strasse_wave31_scenarios.py"
...
def main() -> None:
    lines = [
        '"""Pilot-Welle 31 — PANZEK-Sphäre: 100 Basisszenarien pro Gewerk (generiert)."""',
        "from __future__ import annotations",
