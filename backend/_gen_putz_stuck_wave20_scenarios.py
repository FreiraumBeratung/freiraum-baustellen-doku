"""Generator Putz & Stuck Welle 20 — 300 Basisszenarien.

Fokus: Mengen in Sprache, Materialvorschläge, POB-Struktur, Ketten, kurz/lang.
Erweitert Welle 19 um sum_qty / forbid_layer_mats. Rein additiv.
"""
...
OUT = Path(__file__).parent / "putz_stuck_wave20_scenarios.py"
TARGET = 300
SITE_A = "Höxter"
SITE_B = "Warburg"
SITE_C = "Beverungen"
...
def _calibrate_scenarios(scenarios: list[dict]) -> list[dict]:
    ...
    isolate_smoke_data(_Path(tempfile.mkdtemp(prefix="freiraum_putz_w20_cal_")))
    ...
    def _probe(raw_text: str) -> dict:
        body = StructureReportBody(
            projectId="ps-wave20-cal",
            projectName="Putz Stuck Welle 20 Kalibrierung",
...
def build() -> list[dict]:
    ...
    if dead_idxs:
        ...
        for rep in _calibrate_scenarios(pad_pool):
